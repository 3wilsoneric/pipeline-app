...
reads values or triggers record creation, schedule submission, signature, decision, export,
or handoff.
...
- Every required activity is complete.
- Every scenario assigned to the role has a correct safe decision.
- Every guided tour assigned to the role is complete.
- Every module has self-reported confidence of at least four out of five.
- Evidence exercises contain at least eighty characters of synthetic teach-back.
- A supervisor observes the role walkthrough and exception drill before final sign-off.

Digital completion is not permission escalation and is not a clinical credential.
