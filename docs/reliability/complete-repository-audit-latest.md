...
- Existing repository files: 637
- Tracked paths pending deletion: 0
- Risk classification: 47 critical, 131 high, 132 medium, 327 low
...
| `docs/reliability/complete-repository-audit-latest.md` | Generated audit evidence | medium | 282407 B / 1439 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `docs/reliability/dependency-inventory.json` | Generated audit evidence | medium | 205582 B / 7313 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `docs/reliability/repository-file-inventory.json` | Generated audit evidence | medium | 364836 B / 7371 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `lib/academy/academy-atlas.generated.json` | Shared server/domain library | medium | 194420 B / 7635 lines | Large module (7635 lines): split by behavior before adding more responsibilities. | check:platform:fast and owning feature test |
...
- `lib/academy/academy-atlas.generated.json`: Large module (7635 lines): split by behavior before adding more responsibilities.
