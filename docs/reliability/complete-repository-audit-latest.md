...
- Existing repository files: 635
- Tracked paths pending deletion: 0
- Risk classification: 47 critical, 131 high, 131 medium, 326 low
- Files with concrete static review flags: 139
...
- Review all 139 current static flags; this generator does not auto-dismiss findings from an older audit.
...
| next | runtime | 16.2.11 -> 16.2.11 | MIT | Application framework and server runtime | 158 | Server/client boundary leaks, cache semantics, route-handler behavior, dynamic rendering drift, and framework-version API changes. |
...
| postgres | runtime | ^3.4.9 -> 3.4.9 | Unlicense | PostgreSQL client | 93 | Pool exhaustion, missing transaction boundaries, unsafe dynamic SQL, statement timeouts, retrying non-idempotent writes, and connection leaks. |
...
| `components/pipeline/AssessmentWorkspace.tsx` | Pipeline user interface | medium | 86246 B / 1600 lines | Large module (1600 lines): split by behavior before adding more responsibilities. | typecheck + lint + build + responsive/accessibility E2E |
...
| `docs/refactoring/README.md` | Documentation or runbook | low | 5126 B / 101 lines | Check stale commands, obsolete architecture, contradictory sources of truth, missing owners, unsafe examples, and unverified recovery instructions. | link/config drift review against executable source |
...
| `docs/reliability/complete-repository-audit-latest.md` | Generated audit evidence | medium | 266345 B / 1378 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `docs/reliability/dependency-inventory.json` | Generated audit evidence | medium | 201861 B / 7246 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `docs/reliability/repository-file-inventory.json` | Generated audit evidence | medium | 337230 B / 6804 lines | Do not edit manually; regenerate and verify that inventory counts match the current worktree. | regenerate with npm run audit:repository |
...
| `lib/academy/academy-atlas.generated.json` | Shared server/domain library | medium | 193802 B / 7611 lines | Large module (7611 lines): split by behavior before adding more responsibilities. | check:platform:fast and owning feature test |
...
| `package.json` | Build, runtime, or repository configuration | low | 13455 B / 197 lines | Check local/CI/production parity, secret handling, ignored outputs, runtime version pinning, bundle boundaries, and deployment defaults. | check:platform:fast and owning feature test |
...
- `lib/academy/academy-atlas.generated.json`: Large module (7611 lines): split by behavior before adding more responsibilities.
