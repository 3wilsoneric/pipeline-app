...
Application rollback can retain this additive migration. Its database rollback refuses to restore the older constraint while linked accounts have never signed in, leaving their records intact; never invent a sign-in timestamp to force rollback.
