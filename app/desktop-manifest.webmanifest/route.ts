...
const manifest: MetadataRoute.Manifest = {
  ...
  icons: [
    {
      src: toPipelinePath("/pwa/pipeline-app-icon-192-v11.png"),
      sizes: "192x192",
      type: "image/png",
    },
    {
      src: toPipelinePath("/pwa/pipeline-app-icon-512-v11.png"),
      sizes: "512x512",
      type: "image/png",
    },
    {
      src: toPipelinePath("/pwa/pipeline-app-icon-1024-v11.png"),
      sizes: "1024x1024",
      type: "image/png",
    },
    {
