...
import { readPacketFields } from "@/lib/extraction/extraction-service";
...
export async function GET(
  ...
  return withApiLogging(request, "/api/packets/[packetId]/fields", async () => {
    ...
    const fields = await readPacketFields(packetId);
