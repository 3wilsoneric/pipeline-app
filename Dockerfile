...
COPY scripts/build-runtime-ops-dependencies.mjs ./scripts/build-runtime-ops-dependencies.mjs
RUN node scripts/build-runtime-ops-dependencies.mjs /app/node_modules /app/runtime-ops-node_modules
...
ARG NEXT_PUBLIC_PIPELINE_DESKTOP_ENABLED=false
