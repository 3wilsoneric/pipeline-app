...
export function getReferralProgress(referral: Referral, context: WorkflowContext = {}): ReferralProgress {
  ...
  const sections = [
    section("referral", "Referral information", [
      ...
      item("referrer_name", "Referrer name", hasValue(referral.referrerName), false),
      item("referrer_phone", "Referrer phone", hasValue(referral.phone), false),
      item("referrer_email", "Referrer email", hasValue(referral.email), false),
