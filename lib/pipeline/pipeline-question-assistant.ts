...
const intents: SearchableIntent[] = [
  ...
  intent({
    ...
    answer: "Use Clients for the full directory, or search by client name. A client profile brings governed census information and Pipeline workspace data together without guessing identity matches.",
    steps: ["Open Clients.", "Search the client's name.", "Open the matching profile; review both choices if identities are ambiguous."],
