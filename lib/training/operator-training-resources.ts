...
export const operatorScenarios: readonly OperatorScenario[] = [
  ...
  scenario("dashboard-scope", "A supervisor asks for a total", "Reporting", "important", "A dashboard shows 18 referrals after a community filter, while a prior unfiltered report showed 42.", ["Both displays are current", "The selected month is the same"], allRoles, ["dashboard-meaning", "filter-report-export"], [
...
export const operatorJobAids: readonly OperatorJobAid[] = [
  ...
  jobAid("safe-escalation", "Escalate with safe diagnostics", "When processing, access, or downstream behavior needs support.", allRoles, "Operations", "/?screen=operations", "components/pipeline/OperationsDashboard.tsx", ["Record route and time", "Capture request ID and visible status", "Describe expected and observed behavior", "State operational impact", "Remove PHI and credentials"], ["Suspected privacy exposure", "Unauthorized access", "Repeated data-integrity failure"]),
];
...
export const operatorCapabilities: readonly OperatorCapability[] = [
  ...
  capability("operations", "Operations", "Manage queues, exceptions, metrics, reporting, and recovery.", "Leads / viewers", "Operations", "/?screen=operations", "components/pipeline/OperationsDashboard.tsx", ["workspace", "assessment", "ehr"], ["supervisor-action"], ["dashboard-meaning", "supervisor-exceptions"]),
];
