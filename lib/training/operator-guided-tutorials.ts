...
export const operatorGuidedTutorials: readonly OperatorGuidedTutorial[] = [
  ...
  tutorial({ id: "start-assessment", title: "Schedule an assessment", context: "workspace", persona: "assessor", audiences: writeRoles, summary: "Set the appointment, then begin the assessment.",
    steps: [
      step("schedule-open", assessment, "assessment-schedule-open", "Open scheduling", "Choose Schedule interview in the appointment row. You can enter assessment answers before or after booking. If the form is already open, go to Set the appointment.", "target-click", true),
      ...
      step("schedule-save", assessment, "assessment-schedule-save", "Save the appointment", "Select Schedule interview when the details are correct. The guide advances only after booking succeeds. Skip if you are only looking.", "target-click", true),
