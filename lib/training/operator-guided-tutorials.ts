...
export const operatorGuidedTutorials: readonly OperatorGuidedTutorial[] = [
  ...
  tutorial({
    ...
    steps: [
      ...
      step("assessor-current-work", "/?view=referrals", "workspace-views", "Workspaces", "Show current work", "Current work limits the list to assigned intake and assessment work that can still move.", "Select Current work in the highlighted view control.", "Only active referral work is shown.", "An explicit active scope keeps completed records out of today’s workflow.", "Changing the view never changes referral status or assignment.", "target-click", "right"),
  ...
  tutorial({
    ...
    steps: [
      ...
      step("supervisor-scope", "/?view=referrals", "workspace-views", "Workspaces", "Show current work", "Current work keeps open intake and assessment episodes in view.", "Select Current work in the highlighted controls.", "The active referral inventory is visible.", "Active scope keeps supervisor review focused on work that can still move.", "Changing the view does not alter referral status.", "target-click", "right"),
  ...
  tutorial({
    ...
    minutes: 4,
    persona: "shared",
    clickpath: ["Workspaces", "Current work or All", "Search", "Open referral"],
    audiences: allRoles,
    ...
    steps: [
      ...
      step("find-select-scope", "/?view=referrals", "workspace-views", "Scope", "Choose Current work or All", "Current work shows active referrals. All workspaces supports lookup across the full retained referral record.", "Select the highlighted workspace view that matches your question.", "The chosen referral scope is visible.", "Explicit scope prevents completed and active episodes from being confused.", "Changing the view does not change a referral’s status.", "target-click", "right"),
