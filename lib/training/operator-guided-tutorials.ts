...
export const operatorGuidedTutorials: readonly OperatorGuidedTutorial[] = [
  ...
  tutorial({
    ...
    workflow: "Assessor",
    summary: "Schedule the interview, then open the assessment.",
    ...
    steps: [
      ...
      step("assessment-schedule-method", assessmentSchedulingRoute, "assessment-schedule-method", "Schedule", "Choose the interview method", "The method tells the assessor where the interview will happen and what connection information is required.", "Choose Zoom, in person, phone, or record review. Add a location or link when the method requires one.", "The method and any required location or link are ready to save.", "A complete appointment can be used directly from the assessor calendar.", "Do not place clinical details or unnecessary PHI in the location field.", "target-change", "left"),
...
export const operatorGuideTargetSources: Readonly<Record<string, string>> = {
  ...
  "assessment-schedule-method": "components/pipeline/AssessmentWorkspace.tsx",
