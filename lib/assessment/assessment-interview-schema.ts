...
export const assessmentInterviewQuestions: readonly AssessmentInterviewQuestion[] = [
  ...
  q("injection_frequency", "Medication profile", "textarea", { showWhen: equals("im_injections", "yes"), span: "full", placeholder: "Medication — every 4 weeks", help: "Optional. For multiple medications, use one named medication per line." }),
  q("last_injection", "Medication profile", "textarea", { showWhen: equals("im_injections", "yes"), placeholder: "Medication — date last given, approximate date, or unknown", help: "Optional. Use one named medication per line." }),
  q("next_injection_due", "Medication profile", "textarea", { showWhen: equals("im_injections", "yes"), placeholder: "Medication — next due date, or unknown", help: "Optional. Record the known due date for each medication; no date is calculated." }),
  ...
  ], showWhen: equals("substance_abuse_history", "yes"), help: "Does the client acknowledge how substance use affects their life?" }),
