...
export default defineConfig({
  ...
  use: { ...devices['Desktop Chrome'], baseURL: 'http://127.0.0.1:4177', headless: true, actionTimeout: 30_000, navigationTimeout: 30_000, trace: 'off', screenshot: 'only-on-failure' },
