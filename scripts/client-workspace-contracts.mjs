...
check("unique client-history admission evidence is preserved without inventing decisions", historicalWorkspaceImport.includes("profile?.admit_date") && historicalAdmissionBackfill.includes("unique_profile_match") && !historicalAdmissionBackfill.includes("admissionDecision"));
