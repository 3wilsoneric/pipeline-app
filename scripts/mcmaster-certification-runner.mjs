...
function certificationEnvironment(port, runRoot) {
  ...
  return {
    ...
    // NEXT_PUBLIC flags are compiled into the production artifact. Keep the
    // server half disabled here so health reflects the bundle being scored;
    // desktop state has its own enabled-build browser suite.
    NEXT_PUBLIC_PIPELINE_DESKTOP_ENABLED: "false",
    PIPELINE_DESKTOP_STATE_ENABLED: "false",
    PIPELINE_DESKTOP_E2E: "false",
