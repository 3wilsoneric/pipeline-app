...
assert.match(scorecard, /warm_navigation_ms: browserFrameCertificationLimit\(goals\.warm_navigation_ms\)/, "Warm navigation may allow exactly one browser-frame sampling tick.");
