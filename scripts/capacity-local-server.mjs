// Synthetic-only two-process target. Never points at Azure or production data.
...
const env = {
  ...
  PIPELINE_EXTRACTION_BACKEND: 'mock', PIPELINE_ALLOW_PRODUCTION_MOCK_EXTRACTION: 'true',
