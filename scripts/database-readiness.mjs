...
check("production seed requires the latest migration", productionSeed.includes("0032_extraction_evidence_bounding_boxes") && productionSeed.includes("migrations.length !== 32"));
check("live database smoke requires the latest migration", liveSmoke.includes("0032_extraction_evidence_bounding_boxes") && liveSmoke.includes("migrations.length === 32") && liveSmoke.includes("referral_fields_evidence_bbox_check") && liveSmoke.includes("pipeline.client_update_outbox"));
