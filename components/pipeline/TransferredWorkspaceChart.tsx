...
function WorkspaceClientChartLoader({ referral, headerActions, contactActions, assessment, onEditReferralField, onEditAssessmentField }: {
  ...
  const intakeChart = intakeReferral ? <div className={folderStyles.chartSummary}><ReferralIntakeSummary referral={intakeReferral} headerActions={headerActions} contactActions={contactActions} onEditField={onEditReferralField} /></div> : null;
