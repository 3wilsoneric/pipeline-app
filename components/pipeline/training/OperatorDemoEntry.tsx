...
export default function OperatorDemoEntry({ demoUrl }: { demoUrl: string | null }) {
  ...
  return (
    <section aria-labelledby="pipeline-walkthrough-title">
      ...
      >
        <div>
          <div className="text-[11px] font-bold uppercase tracking-[0.08em] text-[#0f7c68]">Assessor practice</div>
          ...
          <p className="mt-3 max-w-[760px] text-[16px] font-medium leading-6 text-[#4e6860]">See the referral workflow and Language Lab, then work the same synthetic case as an assessor and supervisor.</p>
        </div>
